                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                            ...
                            <div class="flex items-center justify-between mb-4">
                                ...
                                @auth
                                    @if(auth()->user()->is_admin ?? false)
                                        <a href="{{ route('admin.listings.edit', ['listing' => $listing, 'return_to' => 'show']) }}" class="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-lg shadow-md hover:shadow-lg transition-colors">
                        ...
                        <div class="bg-white dark:bg-slate-800 p-6 rounded-xl shadow-lg">
                            ...
                            @auth
                                @php
                                    // Get owner: priority 1 = user_id, priority 2 = contact_email
                                    $seller = $listing->getOwner();
                                    $isSeller = $seller && $seller->id === auth()->id();
                                @endphp
